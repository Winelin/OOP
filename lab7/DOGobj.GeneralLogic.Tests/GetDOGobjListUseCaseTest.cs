    ...
    public class GetDOGobjListUseCaseTest
    {
        private InMemoryDOGobjRepository CreateDOGobjRepository()
        {
            var repo = new InMemoryDOGobjRepository(new List<dogobj> {
                new dogobj { Id = 1, Location = "Библиотека имени Ленина", DepartamentalAffiliation = "Успенский собор"},
                new dogobj { Id = 2, Location = "Библиотека имени Ленина", DepartamentalAffiliation = "Архангельский собор"},
                new dogobj { Id = 3, Location = "Библиотека имени Ленина", DepartamentalAffiliation = "Благовещенский собор"},
                new dogobj { Id = 4, Location = "Библиотека имени Ленина", DepartamentalAffiliation = "Патриаршие палаты с церковью Двенадцати апостолов"},
            });
            return repo;
        }
        [Fact]
